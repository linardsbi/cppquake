...
{
	edge_t		*pnext_edge = nullptr, *pwedge = nullptr;
...
{
	espan_t			*span = nullptr;
	surf_t			*surf = nullptr, *surf2 = nullptr;
	int				iu = 0;
...
void R_LeadingEdge (edge_t *edge)
{
	...
	surf_t			*surf = nullptr, *surf2 = nullptr;
	int				iu = 0;
	double			fu = NAN, newzi = NAN, testzi = NAN, newzitop = NAN, newzibottom = NAN;
